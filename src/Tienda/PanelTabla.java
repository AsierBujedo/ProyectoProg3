...
public class PanelTabla extends JPanel {
	...
	/**
	 * Crea un panel que contiene un JScrollPane con una tabla y un panel botonera con un bot�n para a�adir productos a la cesta.
	 ...
	 * @param color {@link Color} que se le aplicar� a la cabecera de la tabla.
	...
	public static JPanel getPanelTabla(String[] nomColumnas, ArrayList<DatoParaTabla> datos, Color color) {			
		...
		// Bot�n anyadir
		JButton anyadir = new JButton("A�adir a la cesta", new ImageIcon("add.png"));
		...
		info.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Runnable r = () -> {
		            String html = "<html><body width='%1s'><h1>C�digo de producto</h1>"
		            ...
		            JOptionPane.showMessageDialog(null, String.format(html, w, w), "Informaci�n", JOptionPane.INFORMATION_MESSAGE);
		        };
		        SwingUtilities.invokeLater(r);
		        VentanaTienda.logger.log(Level.INFO, "Informaci�n desplegada");
			}
		});
	...
	/** 
	 * Crea un panel que contiene un JScrollPane con una tabla y dos paneles botonera con los elementos necesarios para realizar b�squedas y compras de productos.
	 * @param nomColumnas Array con los nombres de las columnas de la tabla.
	 * @param datos ArrayList<DatoParaTabla> con los datos para la tabla.
				...
				if (tablaCesta.getRowCount() != 0) {
					...
					if (reply == JOptionPane.YES_OPTION) {
						...
						if (!VentanaTienda.loginItem.getText().equals("Login")) {
							...
							JOptionPane.showMessageDialog(null, "Antes de comprar, debes iniciar sesi�n", "Advertencia",
			...
			public void actionPerformed(ActionEvent e) {
				if (tablaCesta.getRowCount() != 0) {
					...
					if (reply == JOptionPane.YES_OPTION) {
						...
						JOptionPane.showMessageDialog(null, "No se elimin� ning�n producto", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
					} 
				}
